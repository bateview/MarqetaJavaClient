...
public class VelocityControlUpdateRequest {
  ...
  public VelocityControlUpdateRequest token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public VelocityControlUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public VelocityControlUpdateRequest association(SpendControlAssociation association) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest merchantScope(MerchantScope merchantScope) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest usageLimit(Integer usageLimit) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest approvalsOnly(Boolean approvalsOnly) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest includePurchases(Boolean includePurchases) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest includeWithdrawals(Boolean includeWithdrawals) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest includeTransfers(Boolean includeTransfers) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest includeCashback(Boolean includeCashback) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest includeCredits(Boolean includeCredits) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest currencyCode(String currencyCode) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest amountLimit(BigDecimal amountLimit) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest velocityWindow(VelocityWindowEnum velocityWindow) {
  ...
  **/
  ...
  public VelocityControlUpdateRequest active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VelocityControlUpdateRequest velocityControlUpdateRequest = (VelocityControlUpdateRequest) o;
    return Objects.equals(this.token, velocityControlUpdateRequest.token) &&
        Objects.equals(this.name, velocityControlUpdateRequest.name) &&
        Objects.equals(this.association, velocityControlUpdateRequest.association) &&
        Objects.equals(this.merchantScope, velocityControlUpdateRequest.merchantScope) &&
        Objects.equals(this.usageLimit, velocityControlUpdateRequest.usageLimit) &&
        Objects.equals(this.approvalsOnly, velocityControlUpdateRequest.approvalsOnly) &&
        Objects.equals(this.includePurchases, velocityControlUpdateRequest.includePurchases) &&
        Objects.equals(this.includeWithdrawals, velocityControlUpdateRequest.includeWithdrawals) &&
        Objects.equals(this.includeTransfers, velocityControlUpdateRequest.includeTransfers) &&
        Objects.equals(this.includeCashback, velocityControlUpdateRequest.includeCashback) &&
        Objects.equals(this.includeCredits, velocityControlUpdateRequest.includeCredits) &&
        Objects.equals(this.currencyCode, velocityControlUpdateRequest.currencyCode) &&
        Objects.equals(this.amountLimit, velocityControlUpdateRequest.amountLimit) &&
        Objects.equals(this.velocityWindow, velocityControlUpdateRequest.velocityWindow) &&
        Objects.equals(this.active, velocityControlUpdateRequest.active);
  }
  ...
  public String toString() {
    ...
    sb.append("class VelocityControlUpdateRequest {\n");
